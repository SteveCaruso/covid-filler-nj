...
Using the [custom bookmarklet generator](https://covid-injection.netlify.app/custom.html), you can create a bookmarklet that works with your own spreadsheet.

The default order of the columns it relies upon (and their possible values) are as follows:

Column | Possible values
------ | ---------------
0:Reserved | (We keep other data here.)
...
6:Address | (Address)
7:City | (City)
8:State | Full State Name, e.g. "New Jersey" or 2-letter code e.g. "NJ"
9:Zipcode | #####
10:Biological sex* | "Male" or "M" <br> "Female" or "F" <br> "Other or prefer not to say" or "O"
11:Gender* | "Male" or "M" <br> "Female" or "F" <br> "Other or prefer not to say" or "O"
...
15-16:Reserved | (We keep other data here.)
